{{- /*
Generic function for merging annotations and labels
{
    context: string
...
*/ -}}
{{- define "eric-oss-pm-stats-calc-handling.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-pm-stats-calc-handling.mergeAnnotations" -}}
  {{- include "eric-oss-pm-stats-calc-handling.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-oss-pm-stats-calc-handling.mergeLabels" -}}
  {{- include "eric-oss-pm-stats-calc-handling.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
